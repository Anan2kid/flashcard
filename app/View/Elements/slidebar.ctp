<script>
    $(function(){
//        var dd = "<?php //echo base_url(); ?>//Categories/index/";
//        alert(dd);
        ...
        $.ajax({
            type:"POST",
            url:action('app\Controller\CategoriesController@index'),
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div data-spy="affix" data-offset-top="45" data-offset-bottom="90" class="affix">
            <ul class="nav" id="sidebar-nav">
          		...
          		<!-- Category Left Side Navigator -->
<!--          		--><?php //foreach ($categories as $category): ?>
<!--          			<li><h4>--><?php //echo $category['Category']['name']; ?><!--</h4></li><!--begin nested list-->-->
<!--          		--><?php //endforeach; ?><!-- -->
